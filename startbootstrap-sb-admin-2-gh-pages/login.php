<!-- filepath: /c:/MAMP/htdocs/EJERCICIO BOOTSTRAP/programing-internet/startbootstrap-sb-admin-2-gh-pages/login.php -->
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="php/login_user.php" method="POST">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Ingresa tu email..." name="email" required>
                                        </div>
                                        <div class="form-group">
